...
// `tabBar={false}` for screens whose phone design replaces the tab bar
// with their own bottom action bar (Mobile-Detail -- phase-j.md
// decision 6). A running Replay session hides it through CSS instead.
export default function RailNav({ account, mode = "stock", tabBar = true }: { account: ReactNode; mode?: Mode; tabBar?: boolean }) {
  ...
  return (
    <>
      <aside className="hidden lg:flex w-[72px] shrink-0 flex-col items-center gap-6 bg-app-chrome py-6">
